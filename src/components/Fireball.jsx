...
if(playerCaught){
    ...
    return (
      ...
      <div className="exp" style={{gridRow:explosions[0]&&explosions[0].y>1&&explosions[0].y-1,gridColumn:explosions[0]&&explosions[0].x}}>{exp}</div>

      <div className="exp" style={{gridRow:explosions[0]&&explosions[0].y<settings.boardWidth&&explosions[0].y-1,gridColumn:explosions[0]&&explosions[0].x+1}}>{exp}</div>

      <div className="exp" style={{gridRow:explosions[0]&&explosions[0].y,gridColumn:explosions[0]&&explosions[0].x>1&&explosions[0].x-1}}>{exp}</div>

      <div className="exp" style={{gridRow:explosions[0]&&explosions[0].y,gridColumn:explosions[0]&&explosions[0].x}}>{exp}</div>

      <div className="exp" style={{gridRow:explosions[0]&&explosions[0].y,gridColumn:explosions[0]&&explosions[0].x<settings.boardWidth&&explosions[0].x+1}}>{exp}</div>

      <div className="exp" style={{gridRow:explosions[0]&&explosions[0].y<settings.boardHeight&&explosions[0].y+1,gridColumn:explosions[0]&&explosions[0].x>1&&explosions[0].x-1}}>{exp}</div>

      <div className="exp" tyle={{gridRow:explosions[0]&&explosions[0].y<settings.boardHeight&&explosions[0].y+1,gridColumn:explosions[0]&&explosions[0].x}}>{exp}</div>

      <div className="exp" style={{gridRow:explosions[0]&&explosions[0].y<settings.boardHeight&&explosions[0].y+1,gridColumn:explosions[0]&&explosions[0].x<settings.boardWidth&&explosions[0].x+1}}>{exp}</div>
